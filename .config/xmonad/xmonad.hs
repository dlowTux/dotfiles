...
myKeys = 
    ...
    -- Browser
    ("M-b", spawn "/opt/firefox/firefox/firefox"),
    -- File explorer
    ("M-e", spawn "nautilus"),
    -- Terminal
    ...
    -- brave
    ("M-o", spawn "brave-browser"),
    --Chromiun
    ("M-c" , spawn "flatpak run org.chromium.Chromium"),
    --LibreWolf
    ("M-l",spawn "flatpak run io.gitlab.librewolf-community"),
    ----------------------VirtualBox-------------------
